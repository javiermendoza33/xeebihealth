    ...
    <CareShell accentColor="#F87171">
      <div style={{ padding: '40px 48px', maxWidth: 1100 }}>
        <div style={{ marginBottom: 36 }}>
          ...
          <h1 style={{ fontSize: 32, fontWeight: 700, color: 'var(--fg)', letterSpacing: -0.5 }}>Need care now?</h1>
        ...
        <div style={{ padding: 40, background: 'linear-gradient(135deg, #7F1D1D, #991B1B)', borderRadius: 20, marginBottom: 24, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 32 }}>
          ...
          <Link href="/patient/care/urgent/intake" style={{ display: 'block', padding: '16px 32px', background: '#F87171', color: 'var(--fg)', borderRadius: 100, fontSize: 16, fontWeight: 700, textDecoration: 'none', whiteSpace: 'nowrap', flexShrink: 0 }}>Start visit now →</Link>
        </div>

        {/* Common symptoms */}
        <div style={{ padding: 32, background: 'var(--card-bg)', border: '1px solid var(--divider)', borderRadius: 20 }}>
          <h2 style={{ fontSize: 18, fontWeight: 700, color: 'var(--fg)', marginBottom: 20 }}>What are you experiencing?</h2>
