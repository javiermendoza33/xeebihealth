    ...
    <CareShell accentColor="#A78BFA">
      <div style={{ padding: '40px 48px', maxWidth: 1100 }}>
        <div style={{ marginBottom: 36 }}>
          ...
          <h1 style={{ fontSize: 32, fontWeight: 700, color: 'var(--fg)', letterSpacing: -0.5 }}>How are you feeling today?</h1>
        ...
        <div style={{ padding: 32, background: 'var(--card-bg)', border: '1px solid var(--divider)', borderRadius: 20, marginBottom: 24 }}>
          <h2 style={{ fontSize: 16, fontWeight: 600, color: 'var(--fg)', marginBottom: 20 }}>Daily mood check-in</h2>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
          ...
          <div style={{ padding: 32, background: 'linear-gradient(135deg, #4C1D95, #7C3AED)', borderRadius: 20 }}>
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              ...
              <Link href="#" style={{ padding: '11px 22px', background: 'rgba(255,255,255,0.15)', color: 'var(--fg)', borderRadius: 100, fontSize: 13, fontWeight: 600, textDecoration: 'none' }}>Psychiatrist →</Link>
            </div>
          </div>

          {/* Resources */}
          <div style={{ padding: 32, background: 'var(--card-bg)', border: '1px solid var(--divider)', borderRadius: 20 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: 'var(--fg)', marginBottom: 20 }}>Resources for you</h2>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              {RESOURCES.map(r => (
                <div key={r.title} style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <p style={{ fontSize: 14, color: 'var(--fg)', fontWeight: 500 }}>{r.title}</p>
